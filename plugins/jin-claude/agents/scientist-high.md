...
When invoked by `/jinzy:research` skill, output these tags to communicate status:
...
### Integration with /jinzy:research Skill

The `/jinzy:research` skill orchestrates multi-stage research workflows. It reads these promise tags to:
